...
<div class="container">
  <article class="card mb-3">
    ...
    <div class="card-body ml-3 mr-3" style="z-index:1;">
        ...
        <a href="{{ route('kelas.createAbsensi', ['id' => $kelas->id]) }}" class="btn btn-light btn-md font-weight-bold" style="z-index: 1; background-color:  rgb(191, 49, 49); color: white; margin-bottom: 10px;">
          Create Absen
        </a>
        <div>
          @foreach ($absensi as $absen)
          <a href="{{ route('kelas.showAbsensiDetail', ['id' => $kelas->id,'absensi_id' => $absen->id]) }}" class="btn btn-light btn-md font-weight-bold" style=" background-color:  white; color: rgb(191, 49, 49); width: 100%; text-align: left; margin-top: 5px; border: 1px solid black;">Pertemuan {{$absen->pertemuan  }}</a>
          @endforeach
        </div>
    </div>
</article>
