...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion " style="background-color: #7D0A0A " id="accordionSidebar">
        ...
        <!-- Nav Item - Kelas saya -->
        <li class="nav-item {{ Nav::isRoute('mahasiswa.indexAbsensi') }}">
            <a class="nav-link" href="{{ route('mahasiswa.indexAbsensi') }}">
                <i class="fas fa-fw fa-graduation-cap"></i>
                <span>{{ __('Absensi Mahasiswa') }}</span></a>
        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; <a href="https://github.com/Project-RPL-LMS-Unsiclass" target="_blank">Unsiclas</a> {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
