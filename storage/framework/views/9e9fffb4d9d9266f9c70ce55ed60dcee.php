...
<div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-dark accordion " style="background-color: #7D0A0A " id="accordionSidebar">
        ...
        <!-- Nav Item - Dashboard -->
        <li class="nav-item <?php echo e(Nav::isRoute('mahasiswa.index')); ?>">
            <a class="nav-link" href="<?php echo e(route('mahasiswa.index')); ?>">
                <i class="fas fa-fw fa-tachometer-alt"></i>
                <span><?php echo e(__('Dashboard')); ?></span></a>
        </li>
        <!-- Nav Item - Kelas saya -->
        <li class="nav-item <?php echo e(Nav::isRoute('mahasiswa.indexAbsensi')); ?>">
            <a class="nav-link" href="<?php echo e(route('mahasiswa.indexAbsensi')); ?>">
                <i class="fas fa-fw fa-graduation-cap"></i>
                <span><?php echo e(__('Absensi Mahasiswa')); ?></span></a>
        </li>
...
<?php /**PATH C:\laragon\www\LMS_Unsiclass\resources\views/layouts/mahasiswa.blade.php ENDPATH**/ ?>